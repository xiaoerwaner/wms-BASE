...
public:
    ...
    void setupUi(QWidget *ConnectionWidget)
    {
        ...
        ConnectionWidget->resize(222, 23);
    ...
    {
        ConnectionWidget->setWindowTitle(QApplication::translate("ConnectionWidget", "Form", nullptr));
        connect_pb->setText(QApplication::translate("ConnectionWidget", "Connect", nullptr));
        label->setText(QApplication::translate("ConnectionWidget", "COM port", nullptr));
    } // retranslateUi

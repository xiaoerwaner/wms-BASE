...
#include "../../Deca/network/RTLSClient.h"
...
void RTLSClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RTLSClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RTLSClient::*)(quint64 , double , double , double , bool , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::anchPos)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RTLSClient::*)(quint64 , double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::tagPos)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (RTLSClient::*)(quint64 , double , double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::tagStats)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (RTLSClient::*)(quint64 , quint64 , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::tagRange)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (RTLSClient::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::statusBarMessage)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (RTLSClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::centerOnAnchors)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (RTLSClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::enableFiltering)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (RTLSClient::*)(int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSClient::ancRanges)) {
                *result = 7;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RTLSClient::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_RTLSClient.data,
    qt_meta_data_RTLSClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };

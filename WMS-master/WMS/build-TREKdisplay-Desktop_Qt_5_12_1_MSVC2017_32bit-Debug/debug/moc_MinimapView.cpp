...
#include "../../Deca/views/MinimapView.h"
...
void MinimapView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MinimapView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MinimapView::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_MinimapView.data,
    qt_meta_data_MinimapView,
    qt_static_metacall,
    nullptr,
    nullptr
} };

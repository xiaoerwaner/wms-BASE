...
#include "../../Deca/RTLSDisplayApplication.h"
...
void RTLSDisplayApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RTLSDisplayApplication *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RTLSDisplayApplication::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RTLSDisplayApplication::ready)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RTLSDisplayApplication::staticMetaObject = { {
    &QApplication::staticMetaObject,
    qt_meta_stringdata_RTLSDisplayApplication.data,
    qt_meta_data_RTLSDisplayApplication,
    qt_static_metacall,
    nullptr,
    nullptr
} };

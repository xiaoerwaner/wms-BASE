...
//#include <QtMultimedia/QCameraInfo>摄像头信息
//#include <QCameraViewfinder> 摄像头取景器
//#include <QtMultimedia/QCameraImageCapture>截图
#include <QFileDialog>
#include <QDebug>
#include "GraphicsWidget.h"
...
void GraphicsWidget::on_pushButton_33_clicked()//地图键按钮
{
    int click_num = 0;
...
/*void GraphicsWidget::on_pushButton_103_clicked()
{
    ...
    if(flag==false)
    {
        ui->groupBox_18->show();//摄像头相关有标题组合框，组合框提供一个框架、一个标题和一个键盘快捷键
        flag=true;
    }
    else
    {
